...
(function(global){
   ...
   * @param {number} passLine - 晋级线
	...
	html += `<div style="margin-bottom:8px;">以下学生在中考中获得金牌，获得了高中的录取通知书：</div>`;
	...
	html += `<button class="btn btn-ghost" id="national-team-decline">结算</button>`;
	//html += `<button class="btn" id="national-team-accept"></button>`;
	html += `</div>`;
