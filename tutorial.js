...
const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    target: '#student-list',
    title: '学生列表',
    content: '这是你的学生。每个学生有<strong>思维</strong>、<strong>书写</strong>、<strong>心理</strong>三项基础能力，以及五大学科。<br>压力过高会影响表现甚至导致退队！',
    position: 'right',
    highlight: true
  },
  {
  ...
  },
  {
    ...
    title: '设施状态',
    content: '这里显示当前的设施等级。升级<strong>投影仪与黑板</strong>和<strong>资料库</strong>可以提升训练效率。<br>升级<strong>空调、宿舍、食堂</strong>可以改善舒适度，降低压力。<br>设施可以通过特定事件（如上级拨款）进行升级。',
    position: 'right',
    highlight: true
  },
  {
    ...
    target: '.action-cards',
    title: '本周行动',
    content: '每周选择一个行动：<br>• <strong>训练</strong>：提升能力和知识<br>• <strong>娱乐</strong>：缓解压力<br>• <strong>模拟考试</strong>：检验成果<br>• <strong>外出补课</strong>：快速提升',
    position: 'left',
    highlight: true
  },
  {
  ...
  },
  {
    ...
    target: '#next-comp',
    title: '考试日程',
    content: '关注下场比赛的时间！比赛前建议安排模拟考试或外出补课来提升实力。<br>考试成绩决定能否晋级下一场。',
    position: 'top',
    highlight: true
  },
  {
